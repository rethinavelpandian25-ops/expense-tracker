...
# Not every platform's system MIME database registers this extension
# correctly out of the box, and Chrome's Android install-ability check for
# the web manifest is strict about the content-type — so this is set
